...
if (!class_exists("findByNameResponse")) {
/**
 * findByNameResponse
 */
class findByNameResponse {
	/**
	 * @access public
	 * @var ProjectAClient
	 */
...
if (!class_exists("findByOrganizationName")) {
/**
 * findByOrganizationName
 */
class findByOrganizationName {
	/**
	 * @access public
	 * @var string
	 */
...
if (!class_exists("findByOrganizationNameResponse")) {
/**
 * findByOrganizationNameResponse
 */
class findByOrganizationNameResponse {
	/**
	 * @access public
	 * @var ProjectAClient[]
	 */
...
if (!class_exists("ProjectAClientService_4110")) {
/**
 * ProjectAClientService_4110
 * @author WSDLInterpreter
 */
class ProjectAClientService_4110 extends SoapClient {
	/**
	...
	private static $classmap = array(
		...
		"findByNameResponse" => "findByNameResponse",
		"findByOrganizationName" => "findByOrganizationName",
		"findByOrganizationNameResponse" => "findByOrganizationNameResponse",
	);
	 ...
	 */
	public function __construct($wsdl="http://stg-emc1.translations.com/PD/services/ProjectAClientService_4110.wsdl", $options=array(), $headers = NULL) {
	 ...
	 * @throws Exception invalid function signature message
	 */
	public function findByName($mixed = null) {
		...
		return $this->__soapCall("findByName", $args);
	}


	/**
	 * Service Call: findByOrganizationName
	 * Parameter options:
	 * (findByOrganizationName) parameters
	 * (findByOrganizationName) parameters
	 * (findByOrganizationName) parameters
	 * @param mixed,... See function description for parameter options
	 * @return findByOrganizationNameResponse
	 * @throws Exception invalid function signature message
	 */
	public function findByOrganizationName($mixed = null) {
		$validParameters = array(
			"(findByOrganizationName)",
			"(findByOrganizationName)",
			"(findByOrganizationName)",
		...
		$args = func_get_args();
		$this->_checkArguments($args, $validParameters);
		return $this->__soapCall("findByOrganizationName", $args);
	}
