...
class checkDownloadDeliverableCollateralResponse {
	/**
	 * @access public
	 * @var ax234DownloadCollateralResult
	 */
	public $return;
}}
...
if (!class_exists("SubmissionService_4110")) {
/**
 * SubmissionService_4110
 * @author WSDLInterpreter
 */
class SubmissionService_4110 extends SoapClient {
	/**
	 ...
	 */
	public function __construct($wsdl="http://stg-emc1.translations.com/PD/services/SubmissionService_4110.wsdl", $options=array(), $headers = NULL) {
