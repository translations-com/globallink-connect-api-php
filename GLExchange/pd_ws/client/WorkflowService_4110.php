...
class findAvailableWorkflowInfosForClaimResponse {
	/**
	 * @access public
	 * @var ax22SubmissionWorkflowInfo[]
	 */
	public $return;
}}
...
if (!class_exists("WorkflowService_4110")) {
/**
 * WorkflowService_4110
 * @author WSDLInterpreter
 */
class WorkflowService_4110 extends SoapClient {
	/**
	 ...
	 */
	public function __construct($wsdl="http://stg-emc1.translations.com/PD/services/WorkflowService_4110.wsdl", $options=array(), $headers = NULL) {
